...
const handleThemeChange = () => {
  ...
  if (currentTheme === 1) {
    ...
    root.style.setProperty("--main-inset-clicked", "inset 0px 0 0px #b3a497");
  ...
  if (currentTheme === 2) {
    ...
    root.style.setProperty("--main-inset-clicked", "inset 0px 0 0px #a79e91");
  ...
  if (currentTheme === 3) {
    ...
    root.style.setProperty("--main-inset-clicked", "inset 0px 0 0px #881c9e");
